...
<div className="tabs justify-center bg-linear-to-r from-pink-600 to-blue-500 text-black text-2xl font-semibold m-10 rounded-full mx-auto items-center w-90 h-20  tabs-box mt-5 bg-transparent">
